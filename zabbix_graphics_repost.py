...
for i in Dict:
    ...
    imagelist.append(a.download_image(i,'/root'))
mail=Mail(user='860087477',passwd='findmy0606',smtpserver='smtp.qq.com',receiver='hasdream@qq.com',subject='zabbix test')
